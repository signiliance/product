...
class Fuzi extends Component{
    ...
    getprodlist = () => {
        ...
        getfuziprodlist({userid: userid}).then((data)=>{
            if(data.code === 200){
                this.setState({
                    list: data.list
                })
    ...
    render () {
        return (
            <div className='content' style={{marginTop: 15}}>
                <div style={{color: 'red'}}>浮动收益产品管理</div>
                <Table
                    style={{marginTop: 15}}
                    columns={this.colums}
